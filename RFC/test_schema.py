...
schntv = {"$schema": "https://json-schema.org/draft/2020-12/schema",
          ...
          "$defs": {
              ...
              "types":   {"enum": ["int32", "float", "point", "date", "string",
                                   "boolean", "object", "json", ""]}
          },
          "allOf": [
...
schntv2 = {"$schema": "https://json-schema.org/draft/2020-12/schema",
           ...
           "allOf": [
                  {"if":  {"properties": {
                      "T": {"const": "int32"}, "E": {"const": "NtvSingle"}}},
                   "then": {"properties": {"V": {"type": "integer"}}}},

                  {"if":  {"properties": {
                      "T": {"const": "date"}, "E": {"const": "NtvSingle"}}},
                   "then": {"properties": {
                      "V": {"pattern": r"(19\d\d|20\d\d)-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01])"}}}}
           ]}
...
schn = {"properties": {"V": {"contains": {"properties": {
    "N": {"const": "test"}, "V": {"maximum": 100}}}}}}
validate(n, schema=schn)
