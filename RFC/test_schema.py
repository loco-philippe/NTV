    ...
    "allOf": [
        {
            ...
            "then": {
                "properties": {"V": {"$ref": "#/$defs/listNTV"}},
                "required": ["E", "V"],
            },
            "else": {"properties": {"V": True}, "required": ["E", "V", "T"]},
        }
    ],
}
...
schntv2 = {
    ...
    "allOf": [
        {
            "if": {
                "properties": {"T": {"const": "int32"}, "E": {"const": "NtvSingle"}}
            },
        ...
        },
        {
            ...
            "then": {
                "properties": {
                    "V": {
                        "pattern": r"(19\d\d|20\d\d)-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01])"
                    }
                }
            },
        },
...
n = {
    ...
    "T": "",
    "V": [
        {"E": "NtvSingle", "N": "test", "T": "json", "V": 45},
...
schn = {
    "properties": {
        "V": {
            "contains": {"properties": {"N": {"const": "test"}, "V": {"maximum": 100}}}
        }
    }
}
validate(n, schema=schn)
