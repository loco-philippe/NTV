    ...
    *instance method*
    ...
    def __init__(self, ope, path=None, entity=None, comment=None, from_path=None):
        ...
        *Parameters*
        ...
        self.from_path = NtvPointer(ope.get("from")) if dic else NtvPointer(from_path)
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.ope == other.ope
            and self.path == other.path
            and self.entity == other.entity
            and self.comment == other.comment
            and self.from_path == other.from_path
        )
...
class NtvPatch:
    ...
    *instance method*
    ...
    def __eq__(self, other):
        ...
        return (
            self.__class__.__name__ == other.__class__.__name__
            and self.list_op == other.list_op
            and self.comment == other.comment
        )
    ...
    def json(self):
        ...
        return {"comment": self.comment, "list-op": [ope.json for ope in self.list_op]}
    ...
    *instance method*
    ...
    def pointer_list(json_pointer):
        ...
        if len(split_pointer) == 0:
            return []
        return [
            int(nam) if nam.isdigit() else nam.replace("~1", "/").replace("~0", "/")
